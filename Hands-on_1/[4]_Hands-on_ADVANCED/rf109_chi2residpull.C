...
void rf109_chi2residpull() {
   ...
   // Change sigma to 3.15 AFTER HAVING GENERATED DATA with sigma = 3
   sigma.setVal(3.15);
   ...
   data->plotOn(frame1, DataError(RooAbsData::SumW2), Name("data"));
   gauss.plotOn(frame1, Name("gauss"));
   ...
   cout << "chi^2 = " << frame1->chiSquare("gauss", "data") << endl;
...
// PLOT
   TCanvas *c = new TCanvas("rf109_chi2residpull", "rf109_chi2residpull", 2800, 1000);
   c->Divide(3);
