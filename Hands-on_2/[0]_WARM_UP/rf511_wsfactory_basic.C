// Organization and simultaneous fits: basic use of the 'object factory'
// associated with a workspace to rapidly build pdfs functions and their
...
void rf511_wsfactory_basic(bool compact = true)
{
   RooWorkspace *w = new RooWorkspace("w", "Title");
